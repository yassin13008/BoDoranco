                                    ...
                                    <div className="collapse show" id="collapseicon2" aria-labelledby="collapseicon2" data-parent="#accordion">
                                        <div className="upcoming-course card-body">
                                            <div className="d-flex">
                                                <div className="flex-grow-1"><span className="f-w-600">UX Development</span><span className="d-block">Course By <a href="#javascript"> Lorem ipsum</a></span><span className="d-block"><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star-half-o font-warning"></i></span></div>
                                                <div>
                                                    <h5 className="mb-0 font-primary">18</h5><span className="d-block">Dec</span>
                                                </div>
                                            </div>
                                            <div className="d-flex">
                                                <div className="flex-grow-1"><span className="f-w-600">Business Analyst</span><span className="d-block">Course By <a href="#javascript">Lorem ipsum </a></span><span className="d-block"><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i></span></div>
                                                <div>
                                                    <h5 className="mb-0 font-primary">28</h5><span className="d-block">Dec</span>
                                                </div>
                                            </div>
                                            <div className="d-flex">
                                                <div className="flex-grow-1"><span className="f-w-600">Web Development</span><span className="d-block">Course By <a href="#javascript">Lorem ipsum </a></span><span className="d-block"><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star-o font-warning"></i></span></div>
                                                <div>
